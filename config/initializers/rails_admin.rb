# RailsAdmin config file. Generated on January 01, 2013 20:31
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['PuraVidaDeals', 'Admin']
  ...
  # config.excluded_models = ['Category', 'Deal', 'Place', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Deal', 'Place', 'User']
  ...
  #     configure :deals, :has_many_association 
  ...
  #     configure :id, :integer 
  #     configure :first_line, :string 
  #     configure :second_line, :string 
  #     configure :description, :text 
  #     configure :email, :string 
  #     configure :phone, :string 
  #     configure :website, :string 
  #     configure :commission, :float 
